...
class DirectMixinRegressionTestCase(unittest.TestCase):
    ...
    def test_direct_send_reply_includes_replied_to_fields(self):
        ...
        with (
            mock.patch.object(client, "generate_mutation_token", return_value="mutation-token"),
            mock.patch("instagrapi.instinx.direct.extract_direct_message", return_value=expected),
    ...
    def test_direct_send_photo_uploads_and_broadcasts_for_thread_ids(self):
        ...
        with (
            mock.patch("instagrapi.instinx.direct.time.time", return_value=1234.567),
        ...
        for suffix in (".jpeg", ".webp"):
            with self.subTest(suffix=suffix):
                ...
                with (
                    ...
                    mock.patch(
                        "instagrapi.instinx.direct.extract_direct_message",
    ...
    def test_direct_send_video_uploads_and_broadcasts_for_thread_ids(self):
        ...
        with (
            mock.patch("instagrapi.instinx.direct.time.time", return_value=1234.567),
            mock.patch("instagrapi.instinx.direct.secrets.token_hex", return_value="a" * 32),
            mock.patch("instagrapi.instinx.direct.random.randint", return_value=111111111111),
    ...
    def test_direct_send_voice_uploads_and_broadcasts_for_thread_ids(self):
        ...
        with (
            mock.patch("instagrapi.instinx.direct.time.time", return_value=1234.567),
            mock.patch("instagrapi.instinx.direct.random.randint", return_value=-99),
