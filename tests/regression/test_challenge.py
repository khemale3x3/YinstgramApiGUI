from instagrapi.instinx.challenge import ChallengeChoice
...
class ChallengeRegressionTestCase(unittest.TestCase):
    ...
    def test_challenge_resolve_simple_fails_fast_when_handler_has_no_code(self):
        ...
        with mock.patch("instagrapi.instinx.challenge.time.sleep") as sleep:
            with self.assertRaises(ChallengeRequired) as cm:
    ...
    def test_challenge_resolve_contact_form_posts_numeric_email_choice(self):
        ...
        with mock.patch("instagrapi.instinx.challenge.requests.Session", return_value=fake_session):
            with mock.patch("instagrapi.instinx.challenge.time.sleep"):
