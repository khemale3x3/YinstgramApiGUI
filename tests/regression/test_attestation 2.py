...
from instagrapi.instinx.attestation import USDID_REFRESH_MARGIN, USDID_REGISTRATION_CLIENT_DOC_ID
from instagrapi.instinx.bloks import AP_2SV_ENTRYPOINT
...
class DeviceAttestationRegressionTestCase(unittest.TestCase):
    ...
    def test_usdid_identity_reuse_force_rotation_and_header_refresh(self):
        ...
        with mock.patch("instagrapi.instinx.attestation.time.time", return_value=1000):
