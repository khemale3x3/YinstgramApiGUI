...
class UploadRegressionTestCase(unittest.TestCase):
    ...
    def test_photo_rupload_sends_private_auth_headers(self):
        ...
        with mock.patch("instagrapi.instinx.photo.prepare_image", return_value=(b"photo-bytes", (720, 720))):
            with mock.patch("instagrapi.instinx.photo.Image.open", return_value=opened):
    ...
    def test_clip_upload_falls_back_to_last_json_media_payload(self):
        ...
        with mock.patch(
            "instagrapi.instinx.clip.analyze_video",
    ...
    def test_video_story_fit_resize_renders_canvas_before_upload(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch("instagrapi.instinx.video.StoryBuilder") as story_builder:
    ...
    def test_clip_analyze_video_closes_video_file(self):
        import instagrapi.instinx.clip as clip_mixin
    ...
    def test_video_analyze_video_closes_video_file_on_save_frame_error(self):
        import instagrapi.instinx.video as video_mixin
    ...
    def test_igtv_crop_thumbnail_closes_source_and_cropped_images(self):
        import instagrapi.instinx.igtv as igtv_mixin
