...
from instagrapi.instinx.private import JSONDecodeError as PrivateJSONDecodeError
from instagrapi.instinx.public import JSONDecodeError as PublicJSONDecodeError
